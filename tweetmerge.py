...
csvmerge = []
for d in dirs:
    csvpath = os.path.join(twtpath, d, "tweets.csv")
...
jsdic = {}
for d in dirs:
    jspath = os.path.join(twtpath, d, "data", "js", "tweets")
...
payloadpath = os.path.join(twtpath, d, "data", "js", "payload_details.js")
...
idxpath = os.path.join(twtpath, d, "data", "js", "tweet_index.js")
